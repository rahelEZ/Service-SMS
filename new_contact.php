...
if (!empty($_POST)) {
    $ncontact_name = $_POST["ncontactName"];
	$ncontact_number = $_POST["ncontactNumber"];
	
    $validation_message = smsModel::require_fields(["ncontactNumber" => "Contact Number"], $_POST);
	if ($validation_message) {
        $err = $validation_message;
    } 
	else if(!$tcontact->contact_number_available($ncontact_number)){
		$err= "Contact number in database";
	}
    else {
		echo "came here";
		$tcontact->new_contact($ncontact_name,$ncontact_number);
                            ...
                            <div class="row clearfix">
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        <div class="form-line">
                                            <input type="text" class="form-control" placeholder="Number" name="ncontactNumber" />
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <div class="form-line">
                                            <input type="text" class="form-control" placeholder="Full Name" name="ncontactName"/>
                                        </div>
