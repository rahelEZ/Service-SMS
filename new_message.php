...
$id= $_SESSION['id'];
if (!empty($_POST)) {
	$nmessage_category = $_POST["nmessageCategory"];
	$nmessage_text = $_POST["nmessageText"];
	
    $validation_message = smsModel::require_fields(["nmessageCategory" => "Message Category"], $_POST);
	...
	*/
		...
		echo "came here";
		$tmessage->new_message($nmessage_category,$nmessage_text,$id);
		header("Location: messages.php?category_id=$nmessage_category");
    }
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        <div class="body">
                            <div class="row clearfix">
                                <div class="col-sm-6">
                                    <select class="form-control show-tick" name="nmessageCategory">
                            ...
                            <div class="row clearfix">
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        <div class="form-line">
                                            <textarea rows="4" class="form-control no-resize" name="nmessageText" placeholder="Message content"></textarea>
                                        </div>
                                    </div>
									
									<div class="error-window alert alert-danger"><?= $err ?></div>
										<div class="form-contol text-right">
                        <a class="btn btn-default" href="to_messages.php">Cancel</a>
