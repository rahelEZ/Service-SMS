...
$id=$_SESSION['id'];
$all_messages = $tmessage->all_messages_for_cat_user($detcatm_id,$id);
...
?>
	 <section class="content">
        <div class="container-fluid">
            ...
            <a href="new_message_client.php" class="red btn btn-lg btn-primary btn-circle red">+</a>
		</div>
            </div>
            <!-- #END# Basic Table -->
            <!-- Striped Rows -->
                    ...
                    <div class="card">
                        <div class="body table-responsive">
                            <table class="table table-striped">
                                ...
                                <td><?php echo $tmessage->get_attribute_value("date_tested",$amessage); ?></td>
								<td><a href="edit_message_client.php?message_id=<?= $amessage ?>" class="btn btn-danger">Edit</a></td>
							   </tr>
								<?php
								   }
								 ?>
