                            ...
                            <div class="row clearfix">
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        <div class="form-line">
                                            <textarea rows="4" class="form-control no-resize" name="edmessageText" value="<?php echo $tmessage->get_attribute_value("message",$edmessage_id);?>"></textarea>
                                        </div>
                                    </div>
									
									<div class="error-window alert alert-danger"><?= $err ?></div>
					<div class="form-contol text-right">
                        <a class="btn btn-default" href="messages.php">Cancel</a>
